...
List<dynamic> swipeCards() {
  return [
    Container(
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song7, width: 80.w, height: 200.h),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song6, fit: BoxFit.cover),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song5, fit: BoxFit.cover),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song4, fit: BoxFit.cover),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song3, fit: BoxFit.cover),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song2, fit: BoxFit.cover),
      ),
    ),
    ...
    SizedBox(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30.0),
        child: Image.asset(song1, fit: BoxFit.cover),
      ),
    ),
  ];
}
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              title,
              style: majorFont.copyWith(color: white, fontSize: 18.0),
            ),
          ],
        ),
      ),
